...
public class EdgeConvertFileParser {
    ...
    public void parseSaveFile() throws IOException { //this method is fucked DEBUG
        ...
        while (currentLine.startsWith("Table: ")) {
            ...
            currentLine = br.readLine(); //this should be "}"
            System.out.println("EdgeConvertFileParser (lines 232) - Should be } :" + currentLine);
            currentLine = br.readLine(); //this should be "\n"
            System.out.println("EdgeConvertFileParser (lines 234) - Should be \"\n\" :" + currentLine);
            currentLine = br.readLine(); //this should be either the next "Table: ", #Fields#
            System.out.println("EdgeConvertFileParser (lines 236) - Should be either the next \"Table: \", #Fields# :" + currentLine);
        }
        while ((currentLine = br.readLine()) != null) {
